...
reviews.push= {name:"Chelsea", rating:4, feedback:"The food was hot."};
console.log(reviews);
...
*/
reviews[7].feedback = {feedback: "this place is chill with really cool people, great for getting work done on weekdays"};
